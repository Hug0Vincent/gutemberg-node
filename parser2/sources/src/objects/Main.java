...
public class Main 
{
	...
	public static void find(File file, List<File> files)
	{
	    ...
	    //Si c'est un fichier, on l'ajoute é la liste
	    else
	    {
	    	files.add(file);
	    }
	...
	/**
	 * Récupére le document correspondant au fichier
	 * @param path
	 * 		Chemin du fichier
	...
	/**
	 * Récupére la page du document correspondant au fichier
	 * @param document
	...
	/**
	 * Permet d'ajouter un document é la liste
	 * @param id
