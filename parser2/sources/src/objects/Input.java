...
public class Input 
{
	...
	/**
	 * Crée un nouveau champs et l'ajoute é la liste
	 * @param type
	...
	/**
	 * Permet de générer les points d'une fiche é partir des inputs qui la forment
	 */
	...
	/**
	 * Ajoute la ligne derniérement créée é l'ensemble des lignes
	 */
	...
	/**
	 * Permet d'ajouter un champ é la fiche
	 * @param c
	 * 		Champ é ajouter
	 */
