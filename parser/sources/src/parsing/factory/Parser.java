...
public class Parser 
{
	...
	/**
	 * Permet d'éliminer certaines balises inutiles ne se trouvant pas toujours aux mêmes endroits
	 * @param text
	...
	/**
	 * Permet d'associer un caractère d'ouverture (, {, [... à un caractère de fermeture ], }, )
	 * @param text
	 * 		Texte à parcourir
	 * @param o
	 ...
	 * @return L'index du caractère de fermeture
	 */
	 ...
	 * TODO : même fonction que findCorrespondantIndex ?
	...
	/**
	 * Permet de trouver le prochain index d'un caractère
	 * @param text
	 * 		Texte à parcourir
	 * @param c
	 * 		Caractère à trouver
	 * @return L'index du caractère
	 */
