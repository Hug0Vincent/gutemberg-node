...
public class Page 
{
	...
	/**
	 * Fait un retour en arrière dans l'arborescence des fiches et champs
	 */
	 ...
	 * @return la fiche ou champ dernièrement utilisé
	 */
	...
	/**
	 * Ajoute un nouvel article à l'input traité
	 */
	...
	/**
	 * Permet d'ajouter un fiche à la page
	 * @param f
	 * 		Nouvelle fiche
	 */
